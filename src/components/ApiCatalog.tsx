                        ...
                        <section className="glass-panel p-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="mb-6">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <button
                                        onClick={() => copyToClipboard(`https://api.websopen.com${activeEndpoint.path}`, 'url')}
                                ...
                                <div className="bg-black/60 p-3 rounded-lg border border-white/5 font-mono text-xs break-all text-blue-300">
                                    fetch("<span className="text-green-400">https://api.websopen.com{activeEndpoint.path}</span>", {"{"} method: "{activeEndpoint.method}" {"}"})
                                </div>
                            </div>
